...
$_['text_checkout_shipping_method']  = 'Étape %s: Livraison méthode';
$_['text_checkout_payment_method']   = 'Étape %s: Paiement méthode';
$_['text_checkout_confirm']          = 'Étape %s: Confirmer Commande';
