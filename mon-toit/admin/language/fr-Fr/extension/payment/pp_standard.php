...
$_['entry_total']					 = 'Total';
$_['entry_canceled_reversal_status'] = 'Annulation du statut d`inversion';
...
$_['help_debug']			    	 = 'Consigne des informations supplémentaires dans le journal système';
$_['help_total']					 = 'Le total de la commande que l`ordre doit atteindre avant que cette méthode de paiement ne devienne active';


// Error

$_['error_permission']				 = 'Attention: Vous n`avez pas la permission de modifier le paiement PayPal!';
