<?php
// HTTP
define('HTTP_SERVER', 'http://o-toit.fr/mon-toit/admin/');
define('HTTP_CATALOG', 'http://o-toit.fr/mon-toit/');
...
define('DIR_TEMPLATE', '/var/www/htmlmon-toit/admin/view/template/');
