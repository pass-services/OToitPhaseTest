						...
						<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-12 col-xs-12 switch-buttons">
									<div id="input-reviews" class="btns">
										<label class="radio-inline">
											<input type="radio" name="find_review" value="1" checked="checked" />
											<span class='btn'><?php echo $text_yes; ?></span>
										</label>
										<label class="radio-inline">
											<input type="radio" name="find_review" value="0" />
											<span class='btn'><?php echo $text_no; ?></span>
										</label>
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-12 col-xs-12 switch-buttons">
									<div id="input-images"  class="btns">
										<label class="radio-inline">
											<input type="radio" name="find_images" value="1" checked="checked" />
											<span class='btn first'><?php echo $text_yes; ?></span>
										</label>
										<label class="radio-inline">
											<input type="radio" name="find_images" value="0" />
											<span class='btn'><?php echo $text_no; ?></span>
										</label>
									</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-12 col-xs-12 switch-buttons">
									<div id="input-customfields" class="btns">
										<label class="radio-inline">
											<input type="radio" name="find_custom_fields" value="1" checked="checked" />
											<span class='btn first'><?php echo $text_yes; ?></span>
										</label>
										<label class="radio-inline">
											<input type="radio" name="find_custom_fields" value="0" />
											<span class='btn'><?php echo $text_no; ?></span>
										</label>
									</div>
								</div>
								...
								<div class="col-sm-12 col-xs-12 switch-buttons">
									<div id="input-importon"  class="btns">
										<label class="radio-inline">
											...
											<span class='btn first'><?php echo $text_product_id; ?></span>
										</label>
										<label class="radio-inline">
											<input type="radio" name="find_importon" value="model_number" />
											<span class='btn'><?php echo $text_model; ?></span>
										</label>
										<label class="radio-inline">
											<input type="radio" name="find_importon" value="product_name" />
											<span class='btn'><?php echo $text_product_name; ?></span>
										</label>
									</div>
								</div>
							</div>
								...
								<div class="col-sm-12 col-xs-12 switch-buttons">
									<div id="input-format" class="btns">
										<label class="radio-inline">
											...
											<span class='btn first'><?php echo $text_xls; ?></span>
										</label>
										<label class="radio-inline">
											<input type="radio" name="find_format" value="xlsx" />
											<span class='btn'><?php echo $text_xlsx; ?></span>
										</label>
										<label class="radio-inline">
											<input type="radio" name="find_format" value="csv" />
											<span class='btn last'><?php echo $text_csv; ?></span>
										</label>
									</div>
								</div>
							</div> */ ?>
