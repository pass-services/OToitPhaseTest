...
// Headings
$_['heading_title'] = 'PayZen - Zahlung mit EC-/Kreditkarte';
$_['text_edit'] = 'Edit PayZen - Zahlung mit EC-/Kreditkarte';

// Text
$_['text_payment'] = 'Zahlung';
$_['text_update_success'] = 'Congratulations, you have successfully modified <b>PayZen - Zahlung mit EC-/Kreditkarte</b> module details !';
$_['text_payzen'] = '<a href="http://www.lyra-network.com" target="_blank"><img src="view/image/payment/payzen.png" alt="PayZen" title="PayZen - Zahlung mit EC-/Kreditkarte" style="border: 1px solid #EEEEEE; width: 90px;" /></a>';
...
$_['tab_payzen_specific'] ='EINMALZAHLUNG';
...
$_['section_payzen_selective_3ds'] = 'SELEKTIVES 3-DS';
...
$_['entry_payzen_contact_email'] = 'Kontakt : ';
$_['entry_payzen_contrib_version'] = 'Modulversion : ';
$_['entry_payzen_gateway_version'] = 'Plattformversion : ';
...
$_['entry_payzen_key_test'] = 'Zertifikat im Testbetrieb';
$_['entry_payzen_key_prod'] = 'Zertifikat im Produktivbetrieb';
...
$_['entry_payzen_3ds_min_amount'] = 'Mindestbetrag zur Aktivierung von 3-DS';
...
$_['desc_payzen_status'] = 'M&ouml;chten Sie die PayZen-Zahlungsart akzeptieren?';
$_['desc_payzen_sort_order']= 'Anzeigereihenfolge: Von klein nach gross.';
$_['desc_payzen_geo_zone'] = 'Ist ein Zahlungsraum ausgew&auml;hlt, so wird diese Zahlungsart nur f&uuml;r diesen verf&uuml;gbar sein.';
$_['desc_payzen_enable_logs'] = 'Logdateien des Moduls aktivieren';

$_['desc_payzen_site_id'] = 'Kennung, die von PayZen bereitgestellt wird.';
$_['desc_payzen_key_test'] = 'Zertifikat, das von PayZen zu Testzwecken bereitgestellt wird (im PayZen-Back office verf&uuml;gbar)';
$_['desc_payzen_key_prod'] = 'Von PayZen bereitgestelltes Zertifikat (im PayZen-Back Office verf&uuml;gbar).';
$_['desc_payzen_ctx_mode'] = 'Kontextmodus dieses Moduls.';
$_['desc_payzen_platform_url'] = 'Plattform-URL.';
$_['entry_payzen_url_check'] = 'URL vor &Uuml;bertragung in Ihr PayZen pr&uuml;fen.';

$_['desc_payzen_language'] = 'W&auml;hlen Sie bitte die Spracheinstellung der Zahlungsseiten aus.';
...
$_['desc_payzen_payment_cards'] = 'Liste der/die f&uuml;r die Zahlung verf&uuml;gbare(n) Kartentyp(en), durch Semikolon getrennt.';
$_['desc_payzen_3ds_min_amount'] = 'Muss f&uuml;r die Option Selektives 3-D Secure freigeschaltet sein.';
...
$_['text_payzen_default'] = 'Einstellung Back Office';
