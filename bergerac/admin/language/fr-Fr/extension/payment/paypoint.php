...
$_['text_success']		 = 'Succès: vous avez modifié les détails du compte PayPoint!';
$_['text_edit']          = 'Modifier le point de paiement';
...
$_['help_password']		 = 'Laissez vide si l`authentification par clé Digest n`est pas activée sur votre compte.';
$_['help_total']		 = 'Le total de la commande que l`ordre doit atteindre avant que cette méthode de paiement ne devienne active.';


// Error

$_['error_permission']   = 'Attention: Vous n`êtes pas autorisé à modifier le paiement PayPoint!';
