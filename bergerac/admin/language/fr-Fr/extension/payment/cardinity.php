...
$_['heading_title']			= 'Cardinalité';


// Text

$_['text_extension']		= 'Extensions';
$_['text_success']			= 'Succès: Vous avez modifié le module de paiement Cardinity!';
...
$_['text_error_generic']	= 'Erreur: Une erreur est survenue lors de votre demande. Veuillez vérifier les journaux.';
...
$_['error_composer']		= 'Impossible de charger le SDK Cardinity. Veuillez télécharger un dossier de fournisseur compilé ou exécuter un compositeur.';
$_['error_php_version']		= 'Version minimale de PHP 5. 4. 0 est requis!. ';
$_['error_permission']		= 'Attention: Vous n`avez pas la permission de modifier le paiement Cardinity!';
$_['error_connection']		= 'Un problème est survenu lors de l`établissement d`une connexion à l`API Cardinity. Veuillez vérifier vos paramètres clés et secrets.';
