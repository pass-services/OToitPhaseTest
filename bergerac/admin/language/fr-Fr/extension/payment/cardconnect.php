...
$_['help_transaction']              = 'Choisissez \.';
$_['help_site']                     = 'Cela détermine la première partie de l`URL de l`API. Ne changer que si demandé.';
...
$_['help_cron_url']                 = 'Définir un travail cron pour appeler cette URL afin que les commandes soient mises à jour automatiquement. Il est conçu pour être exécuté quelques heures après la dernière capture d`un jour ouvrable.';
...
$_['button_inquire_all']            = 'Renseignez-vous tous';
