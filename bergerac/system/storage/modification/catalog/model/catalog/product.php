...
class ModelCatalogProduct extends Model {
	...
	public function getProducts($data = array()) {
		$sql = "
            SELECT p.product_id, IF(p.quantity > 0, p.sort_order, p.sort_order + 1000) as n_sort_order,
		...
		if (isset($data['sort']) && in_array($data['sort'], $sort_data)) {
            ...
            $sql .= " ORDER BY n_sort_order ASC, LCASE(" . $data['sort'] . ")";
            
			} elseif ($data['sort'] == 'p.price') {
				
            $sql .= " ORDER BY n_sort_order ASC, (CASE WHEN special IS NOT NULL THEN special WHEN discount IS NOT NULL THEN discount ELSE p.price END)";
            ...
            $sql .= " ORDER BY n_sort_order ASC, p.sort_order";
	...
	public function getProductSpecials($data = array()) {
		$sql = "
            SELECT ps.product_id, IF(p.quantity > 0, p.sort_order, p.sort_order + 1000) as n_sort_order,  
