  ...
  <div class="row"><?php echo $column_left; ?><?php echo $column_right; ?>
    ...
    <div id="content" class="product-page-content" itemscope itemtype="http://schema.org/Product">
      ...
      <div class="row product-info <?php echo $this->journal2->settings->get('split_ratio'); ?>">
        ...
        <?php } ?>
        <div class=<?php
				if ($prod_quant>0) echo "'left'";
				else echo "'left' style='filter: gray; filter: grayscale(100%); -webkit-filter: grayscale(100%); opacity: 0.8;'";
				?>>
          <?php if ($thumb) { ?>
          <div class="image">
        ...
        <div class="right">
          ...
          <ul class="list-unstyled description">
		   ...
		   <!-- Début de modif de code modif de code -->
		    <li><?php echo $sku; ?></li> 
		   <!-- fin de modif de code -->
