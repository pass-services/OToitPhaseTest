                                    ...
                                    <div class="post-wrapper">
                                        ...
                                        <div class="post-item-details post-content-align<?php echo $content_align; ?>">
                                            ...
                                            <div class="post-button">
                                                <a class="post-view-more button" href="<?php echo $post['href']; ?>"><i class="post-button-left-icon"></i><?php echo $this->journal2->settings->get('blog_button_read_more', 'Lire la suite'); ?><i class="post-button-right-icon"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
