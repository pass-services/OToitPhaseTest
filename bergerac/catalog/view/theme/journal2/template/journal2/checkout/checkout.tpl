                    ...
                    <section class="section-right">
                        ...
                        <div class="checkout-content confirm-section">
                            ...
                            <div class="confirm-order">
                                <button id="journal-checkout-confirm-button" data-loading-text="<?php echo $this->journal2->settings->get('one_page_lang_loading_text', 'Loading..'); ?>" class="button confirm-button"><?php echo $this->journal2->settings->get('one_page_lang_confirm_order', 'Valider la commande'); ?></button>
                            </div>
                        </div>
                    </section>
                </div>
