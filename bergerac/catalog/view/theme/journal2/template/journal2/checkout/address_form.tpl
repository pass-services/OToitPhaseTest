<div class="<?php echo $is_logged_in ? 'checkout-content' : ''; ?> checkout-<?php echo $type; ?>-form">
    <?php if ($is_logged_in): ?>
    <h2 class="secondary-title"><?php echo $type === 'payment' ? $this->journal2->settings->get('one_page_lang_bill_address', 'Adresse de Facturation') : $this->journal2->settings->get('one_page_lang_ship_address', 'Delivery Address'); ?> </h2>
    <?php endif; ?>
