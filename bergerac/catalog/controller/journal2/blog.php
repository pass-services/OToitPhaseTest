...
class ControllerJournal2Blog extends Controller {
    ...
    public function feed() {
        ...
        foreach ($this->model_journal2_blog->getPosts($data) as $post) {
            ...
            $description .= '<a href="' . $this->url->link('journal2/blog/post', 'journal_blog_post_id=' . $post['post_id']) . '">' . $this->journal2->settings->get('blog_button_read_more', 'Lire la suite') .'</a>';
