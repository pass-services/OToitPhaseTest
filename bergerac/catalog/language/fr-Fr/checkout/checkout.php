...
$_['heading_title']                  = 'Passer la commande';
...
$_['text_checkout_account']          = 'Étape %s: Compte &amp; Détails de Facturation ';
...
$_['text_guest']                     = 'Checkout invité';
$_['text_register_account']          = 'En créant un compte, vous pourrez faire des achats plus rapidement et garder une trace des commandes que vous avez faites précédemment.';
...
$_['text_payment_method']            = 'Veuillez sélectionner le mode de paiement préféré à utiliser pour cette commande.';
...
$_['text_trial_description']         = '%s chaque %d %s( s ) pour %d Paiement ( s ) puis';
$_['text_payment_description']       = '%s chaque %d %s( s ) pour %d Paiement ( s )';
$_['text_payment_cancel']            = '%s chaque %d %s( s ) jusqu`à annulé';
$_['text_day']                       = 'journée';
...
$_['entry_newsletter']               = 'je souhait à souscrire à la %s bulletin.';
$_['entry_shipping'] 	             = 'Mes adresses de livraison et de facturation sont les mêmes.';


// Error

$_['error_warning']                  = 'Un problème est survenu en essayant de traiter votre commande!  <a href="%s"> cliquant ici </a> .';
...
$_['error_agree']               = 'Attention: Vouz devez accepter nos conditions générales de vente. ';
...
$_['error_no_payment']               = 'Attention: aucune option de paiement n`est disponible. S`il vous plaît.  <a href="%s"> Contactez nous </a> à l`aide!';
