...
$_['text_title']												= 'Payer avec Crédit Carte ( eWAY )';
$_['text_credit_card']											= 'Détails de la carte de crédit';
$_['text_testing']												= 'Cette passerelle de paiement est actuellement testée. Votre carte de crédit ne sera pas débitée. <br /> S`il s`agit d`une commande réelle, veuillez utiliser un autre mode de paiement en ce moment.';
...
$_['entry_cc_cvv2']												= 'Carte Sécurité code ( CVV 2)';
