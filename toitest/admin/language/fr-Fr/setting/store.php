...
$_['help_url']                     = 'Inclure l`URL complète dans votre magasin. Assurez-vous d`ajouter `/` à la fin. Exemple: http: // www. ton domaine. com / chemin /.  <br />  <br /> Ne pas utiliser les répertoires pour créer un nouveau magasin. Vous devriez toujours diriger un autre domaine ou sous-domaine vers votre hébergement.';
$_['help_ssl']                     = 'URL SSL vers votre magasin. Assurez-vous d`ajouter `/` à la fin. Exemple: http: // www. ton domaine. com / chemin /.  <br />  <br /> Ne pas utiliser les répertoires pour créer un nouveau magasin. Vous devriez toujours diriger un autre domaine ou sous-domaine vers votre hébergement.';
...
$_['help_tax_customer']            = 'Utiliser l`adresse par défaut des clients lorsqu`ils se connectent pour calculer les taxes. Vous pouvez choisir d`utiliser l`adresse par défaut pour l`adresse de livraison ou de paiement du client.';
...
$_['error_permission']             = 'Attention: Vous n`êtes pas autorisé à modifier les magasins!';
...
$_['error_store']                  = 'Attention: Ce le magasin ne peux pas être supprimé comme il est actuellement attribué à %s ordres!';
