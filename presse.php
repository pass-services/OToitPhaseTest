...
<title>O'Toit, Espace Presse </title>
<!-- Bootstrap Core CSS -->
...
<!-- FIN INCLUDE DU HEADER -->	
	<div class="masthead3 d-flex jaunehaut  mgtop4">
		<div class="container-fluid minimge ">
			<div class="row">
					<div class="col-md-12 text-center"><h1 class="introtitre">Espace Presse </h1></div>
			</div>	
			<br><br>
			<div class="row ">
					<div class="col-md-12">
											
						<p class="introtitre text-center">Evénement : le 25 mai 2018, O’toit lance le Toit de Bergerac.
Le premier Toit d’une longue série.</p><br>

<p class="text-center intro2light"> <a href="assets/file/cp-mai-2018.pdf" target="_blank" > Télécharger le Communiqué de Presse du 22 Mai 2018</a></p>
<br>
<p class="intro2light ">Vous souhaitez en savoir plus sur ce nouveau modèle de consommation et d’échange,
interviewer les fondateurs, réaliser un reportage, utiliser des photos ?<br>
Nous sommes à votre écoute.</p>
	   ...
	   <p class="intro2light text-center"> <a href="tel:+33699644523">06.99.64.45.23</a>	</p>
<p class="intro2light text-center">	       <a href="mailto:nadege@digimiam.com">nadege@digimiam.com</a></p>
					</div>
