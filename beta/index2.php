...
<!-- FIN INCLUDE DU HEADER -->	
	...
	<div class="row mtopm25">
							...
							<div class="col-md-4 col-sm-12 col-xs-1 ">
									...
									<div class="col-md-4 col-sm-4 col-xs-4 nopad1"><a href="#interet"><img src="assets/img/btn2.png" alt="aremplir" class="img-fluid"></a></div>	
									<div class="col-md-4 col-sm-4 col-xs-4 nopad1"><a href="https://o-toit.fr/bergerac/"><img src="assets/img/btn3.png" alt="aremplir" class="img-fluid"></a>	</div>	
								<br><br>
...
Nos réelles différences : </p>
				...
				<div class="row">
					...
					<div class="col-md-4   "><span class="gras">B.</span> Les bénéfices de chaque toit permettent de dynamiser l’emploi et de participer au développement économique<br> de votre région. 
					</div>
					<div class="col-md-4  "><span class="gras">C.</span> Pas de gaspillage : nous faisons produire uniquement<br> ce que vous commandez.
					</div>
					</div></div>
...
<p class="intro4light">Pour suivre l’actualité des Toits.</p>
					...
					<p class="intro4light">Frédéric vous accueille : route d'Agen, lieu dit la Merille, 24100 Bergerac.</p>
								</div></div>
								<div class="col-md-3 paddy ">
								<div class="article">
...
<br><br><br><br>
	...
	<div class="container-fluid ">
		...
		<div class="row text-center">
				...
				<div class="gros">
				<a href="https://o-toit.fr/bergerac/" class="eight50 btn btn-outline-dark btn-block" role="button" > <br> <div ><img src="assets/img/case.png" class="img-fluid vali" alt="test"><span  class="introtitre4 blanhov"> Entrez c'est ouvert !</span></div><br><br></a>
				<br></div>
		...
		<div class="container-fluid minimge ">
				...
				<div class="row">
					...
					de votre région et vous désirez voir votre centre ville vivre mieux ? </li></ul>
										...
										<p class ="intro2light bord gras">Rejoignez le mouvement des lucioles sur Facebook </p>
<span>Et découvrez qu’ensemble tout devient possible (à commencer par éclairer le présent). </span>
								<br><div ><a href="https://www.facebook.com/MouvementLucioles/" target="_blank"><img src="assets/img/devenir-une-luciole.png" alt="aremplir">	</a></div>	</div>
					</div>
	</div>
	</div>	
<!-- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ZONE 9 ETES VOUS UNE LUCIOLE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->		
...
<p class="intro2light  ">Chez O’toit, il n’y a pas de clients, pas de clientes, pas de consommateurs,<br>
...
<p class="intro2light gras ">1. En rejoignant le mouvement des LUCIOLES
sur les réseaux sociaux et en éclairant autour de vous.
Éclairer l’avenir mais aussi la production des aliments
et les bonnes pratiques de tout le monde.</p>
<p class="intro6light ">Vous pourrez : <br>
...
<p class="intro6light ">Vous pourrez :<br>
- échanger avec les Lucioles de votre Toit sur les centres<br>
d’intérêts qui vous intéressent,<br>
...
<a href="https://www.facebook.com/OToit-Bergerac-2119632094728793/" target="_blank"><img src="assets/picto/Picto-facebook2.png" alt="test"></a>&ensp;	<a href="https://twitter.com/mvtlucioles" target="_blank"><img src="assets/img/twitter2.png " alt="test"></a>&ensp;<a href="https://www.instagram.com/mouvementlucioles/" target="_blank"><img src="assets/img/Instagram2.png" alt="test"></a>
		<br><br>	<br><br>		
</div>

<div class="col-md-6 madroite ">
<p class="introminlight gras ">#Otoit #OtoitBergerac</p>
				<a href="https://www.facebook.com/OToit-Bergerac-2119632094728793/" target="_blank"><img src="assets/picto/Picto-facebook2.png" alt="test"></a>
				</div>
