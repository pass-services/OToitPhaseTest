...
$_['text_success']                 = 'Connexion et paiement avec le module Amazon a été mis à jour';
...
$_['text_tan']                     = 'bronzer';
$_['text_white']                   = 'blanc';
$_['text_light']                   = 'Lumière';
$_['text_dark']                    = 'Foncé';
$_['text_size']                    = 'Taille';
$_['text_medium']                  = 'Moyen';
$_['text_large']                   = 'Grand';
$_['text_x_large']                 = 'Extra large';
$_['text_background']              = 'Contexte';
$_['text_edit']					   = 'Modifier la connexion et payer avec Amazon';
...
';
$_['text_amazon_join']             = ' <a href="http://go.amazonservices.com/opencart.html" target="_blank" title="Sign-up to Login and Pay with Amazon">  <u> Inscrivez-vous pour vous connecter et payer avec Amazon </u>  </a> 
';
$_['text_payment_info']			   = 'Informations de paiement';
$_['text_capture_ok']			   = 'Capture a été réussie';
$_['text_capture_ok_order']		   = 'La capture a été réussie, l`autorisation a été entièrement capturée';
$_['text_refund_ok']			   = 'Le remboursement a été demandé avec succès';
$_['text_refund_ok_order']		   = 'Le remboursement a été demandé avec succès, le montant entièrement remboursé';
$_['text_cancel_ok']			   = 'L`annulation a réussi, le statut de la commande a été mis à jour et annulé';
...
$_['text_minimum_total']           = 'Total de la commande minimum';
...
$_['text_amazon_timeout']          = 'TransactionTimeOut';
$_['text_amazon_no_declined']      = '--- Pas d`autorisation automatique refusée ---';
$_['text_amazon_signup']		   = 'Inscrivez-vous pour vous connecter et payer avec Amazon';
$_['text_credentials']			   = 'S`il vous plaît coller votre clés ici ( dans JSON format )';
...
$_['entry_login_pay_test']         = 'Mode d`essai';
...
$_['help_checkout']				   = 'Si le bouton de paiement se connecte également le client';
$_['help_capture_status']		   = 'Choisir le statut de la commande qui déclenchera la capture automatique d`un paiement autorisé';
$_['help_ipn_url']				   = 'Définissez cette URL en tant que marchand dans Amazon Seller Central';
$_['help_ipn_token']			   = 'Rendez cela long et difficile à deviner';
...
$_['error_client_id']			   = 'L`identification du client est requise';
$_['error_client_secret']		   = 'La clé du client est requise';
...
$_['error_curreny']                = 'Votre boutique doit avoir %s devise installée et activée';
