 ...
 */
    ...
    class Commande_ProxiPage extends Page
    {
        ...
        {
            $selectQuery = 'SELECT  OD.`order_id`,OD.`order_status_id`, OP.`quantity`, OP.`price`, CU.`lastname` , PR.`product_id`,PR.`manufacturer_id`,PD.`name`
            FROM `oc_order` OD
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'price', 'price', 'Prix')
            );
        }
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new NumberViewColumn('price', 'price', 'Prix', $this->dataset);
            $column->SetOrderable(true);
