 ...
 */
    ...
    class Query01Page extends Page
    {
        ...
        {
            $selectQuery = 'SELECT  OD.`order_id`,OD.`date_added`,OD.`order_status_id`, OP.`quantity`,OP.`price`, CU.`lastname` , PR.`product_id`,PR.`manufacturer_id`,PD.`name`
            FROM `oc_order` OD
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['order_status_id'])
        ...
        {
            $main_editor = new SpinEdit('manufacturer_id_edit');
            ...
            $main_editor = new SpinEdit('order_status_id_edit');
        ...
        {
            //
            // View column for manufacturer_id field
            //
            $column = new NumberViewColumn('manufacturer_id', 'manufacturer_id', 'Manufacturer Id', $this->dataset);
            ...
            //
            $column = new NumberViewColumn('product_id', 'product_id', 'Product Id', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
            ...
            //
            $column = new NumberViewColumn('order_status_id', 'order_status_id', 'Order Status Id', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new SpinEdit('manufacturer_id_edit');
            $editColumn = new CustomEditColumn('Manufacturer Id', 'manufacturer_id', $editor, $this->dataset);
            ...
            //
            $editor = new SpinEdit('order_status_id_edit');
            $editColumn = new CustomEditColumn('Order Status Id', 'order_status_id', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
    ...
    try
    {
        $Page = new Query01Page("Query01", "Recap des ventes.php", GetCurrentUserPermissionSetForDataSource("Query01"), 'UTF-8');
        $Page->SetTitle('Recap des ventes');
        $Page->SetMenuLabel('Recap des ventes');
