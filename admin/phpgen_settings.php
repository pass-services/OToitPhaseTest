...
{
    $result = array();
    $result[] = array('caption' => 'Commande Pgc', 'short_caption' => 'Commande PGC à passer', 'filename' => 'cde-pgc.php', 'name' => 'CommandePgc2', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Commande Proxi', 'short_caption' => 'Commande Proxi', 'filename' => 'cde-proxi.php', 'name' => 'Commande Proxi', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Commandes en attente', 'short_caption' => 'Commandes en attente', 'filename' => 'oc_order.php', 'name' => 'oc_order', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Commandes Complète', 'short_caption' => 'Commandes Complète', 'filename' => 'oc_order01.php', 'name' => 'oc_order01', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
