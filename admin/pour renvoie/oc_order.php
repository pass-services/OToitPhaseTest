 ...
 */
    ...
    class oc_orderPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $this->dataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'order_status_id = 1'));
        }
    ...
    try
    {
        $Page = new oc_orderPage("oc_order", "oc_order.php", GetCurrentUserPermissionSetForDataSource("oc_order"), 'UTF-8');
        $Page->SetTitle('Commandes en attente');
        $Page->SetMenuLabel('Commandes en attente');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("oc_order"));
